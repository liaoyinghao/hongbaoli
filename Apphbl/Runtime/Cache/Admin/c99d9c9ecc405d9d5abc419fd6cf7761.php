            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo U('Login/signout');?>"><i class="lnr lnr-exit"></i> <span>注销</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
									...
									<table class="xinwenbg" border="1px" style="margin: 0 auto;">
										<thead style="background: #f5fffd;">
											<tr>
												...
												<td class="col-md-3">新闻名称</td>
												<td class="col-md-2">发布者</td>
												<td class="col-md-2">发布时间</td>
												<td class="col-md-2">浏览量</td>
...
<footer>
	...
	<script type="text/javascript">
		$(function () { $(".daolanleft li").eq(2).find("a").addClass("active"); })
	</script>
</body>
