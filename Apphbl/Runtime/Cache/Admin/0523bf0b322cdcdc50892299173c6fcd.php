						...
						<div class="row" style="width: 95%;margin: 0 auto;">
							...
							<div class="panel">
								...
								<div class="panel-heading">
									<h3 class="panel-title">管理管理员</h3>
									<p class="panel-subtitle">Management Administrator</p>
								</div>
									...
									<table class="xinwenbg" border="1px" style="margin: 0 auto;">
										<thead style="background: #f5fffd;">
											<tr>
												...
												<td class="col-md-2">用户密码</td>
												<td class="col-md-2">注册时间</td>
												<td class="col-md-2">登录次数</td>
												<td class="col-md-1">删除管理员</td>
											</tr>
										</thead>
										<tbody>
											<tr><td>admin</td><td>******</td><td>2016-08-02 12:12:12</td><td>12</td><td><a href="#">删除</a></td></tr>
										</tbody>
									</table>
								</div>
							</div>
...
<footer>
	...
	<script type="text/javascript">
		$(function () {
			...
			$(".daolanleftli>div>ul>li").eq(1).find("a").addClass("active");
		})
	</script>
</body>
